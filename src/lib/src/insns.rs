...
pub fn get_insn_opcode(insn: Insn) -> u8 {
    match insn {
        ...
        Insn::LDA(AddressMode::Absolute) => 0xad,
        Insn::LDA(AddressMode::AbsoluteX) => 0xbd,
        Insn::LDA(AddressMode::AbsoluteY) => 0xb9,
        Insn::LDA(AddressMode::Immediate) => 0xa9,
        Insn::LDA(AddressMode::IndirectY) => 0xb1,
        Insn::LDA(AddressMode::Xindirect) => 0xa1,
        Insn::LDA(AddressMode::Zeropage) => 0xa5,
        Insn::LDA(AddressMode::ZeropageX) => 0xb5,
        Insn::LDX(AddressMode::Absolute) => 0xae,
        Insn::LDX(AddressMode::AbsoluteY) => 0xbe,
        Insn::LDX(AddressMode::Immediate) => 0xa2,
        Insn::LDX(AddressMode::Zeropage) => 0xa6,
        Insn::LDX(AddressMode::ZeropageY) => 0xb6,
        Insn::LDY(AddressMode::Absolute) => 0xac,
        Insn::LDY(AddressMode::AbsoluteX) => 0xbc,
        Insn::LDY(AddressMode::Immediate) => 0xa0,
        Insn::LDY(AddressMode::Zeropage) => 0xa4,
        Insn::LDY(AddressMode::ZeropageX) => 0xb4,
